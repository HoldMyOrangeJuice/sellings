...
import Operator from "../operator/BaseOperator"
import Operand from "../evaluate/BaseOperand"
import Linker from "../core/Linker"

import {BraceBlock, RoundBracketBlock, SquareBracketBlock} from "./BraceBlocks"
...
class ExpressionParser extends Parser
{
    ...
    testGrabOperator()
    {
        for (let operatorClass of Linker.getRegisteredOperators())
        {

            let cls = operatorClass;
