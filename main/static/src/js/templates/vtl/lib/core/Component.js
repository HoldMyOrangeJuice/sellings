...
import {Stack} from "../context/scope"
import TagManager from "./manager/TagManager"
import RenderableHtmlWrapper from "./RenderableHtmlWrapper"
...
class Component
{
	...
	render(ctx)
    {
		...
		while (prs.hasNext())
        {
            ...
            {
				//console.log("read block with compounds");
                try
                {
