        ...
        return `
                <tr class='${dark?"td-dark":""}'>
                    <td title="Открыть на странице" style="font-weight: 600; width: 25%">
                        ...
                        <br>
                        <button class='mt-4 btn btn-dark' onclick='OrderForm.open(${item.id})'>Заказать</button>
                    </td>
                ...
                `<table class='table table-bordered'>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan='3'>
                            <button class='btn btn-warning btn-lg' onclick="OrderForm.open(${item.id}, ${item.subcat_id})">Заказать</button>
